...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/boonyarit.i/workspace/personal/money-manager/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/boonyarit.i/workspace/personal/money-manager/public/storage','insights.preset','insights.ide','insights.exclude',
...
'filament.admin.pages.dashboard','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.user.auth.login',
'filament.user.auth.register','filament.user.auth.logout','filament.user.auth.email-verification.prompt','filament.user.auth.email-verification.verify','filament.user.pages.dashboard',
'livewire.update','livewire.upload-file','livewire.preview-file','home','profile.edit','profile.update','profile.destroy',
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','home',
'layouts.app','layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
